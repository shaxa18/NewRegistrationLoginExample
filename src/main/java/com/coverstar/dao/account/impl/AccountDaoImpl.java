...
public class AccountDaoImpl implements AccountDao {
	...
	@Override
	public Page<Account> findByUsernameContainingOrEmaiContaining(String search, Pageable pageable) {
		return accountRepository.findByUsernameContainingOrEmailContaining(search, search, pageable);
	}
